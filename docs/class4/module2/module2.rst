...
**In Lab 5** we are offering a bonus application routing lab where requests from the backend server will be routed to AWS or Azure frontend based on URI. You will also 
